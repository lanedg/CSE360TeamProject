...
public class ValidateEmailInput {
	...
	public static String checkEmailAddress(String input) {
		...
		case 0:
			...
			emailAddressIndexofError = currentCharNdx;		// Copy the index of the current character;
			emailAddressErrorMessage = "First character following a period may only be alphanumeric.\n";
		...
		case 1:
			...
			emailAddressErrorMessage = "Must be alphanumeric or the special characters . or @ until after the first occurence of @.\n";
			return emailAddressErrorMessage;
			// Replace this with the required code
		...
		case 2:
			...
			emailAddressIndexofError = currentCharNdx;
			emailAddressErrorMessage = "An @ symbol must be followed by an alphanumeric character.";
			return emailAddressErrorMessage;
			// Replace this with the required code
		...
		case 4:
			...
			emailAddressIndexofError = currentCharNdx;
			emailAddressErrorMessage = "A dash after @ in the domain address may only be followed by an alphanumeric character.";
			return emailAddressErrorMessage;
			// Replace this with the required code
